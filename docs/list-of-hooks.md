...
*   [usePreventBodyScroll](https://react-hooks.org/docs/usePreventBodyScroll) - A react hook to prevent body scroll. Optionally takes a condition when which disables body scroll only when the condition is true.
