...
describe("useMediaMatch", function () {
  afterEach(function () {
    delete window.matchMedia;
  });
  it("should track a boolean", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        addEventListener.mockImplementationOnce(function (_, l) {
          return (listener = l);
        });
        window.matchMedia = matchMedia;
        (_a = (0, react_hooks_1.renderHook)(
          function (_a) {
            var query = _a.query;
            return (0, useMediaMatch_1.useMediaMatch)(query);
          },
          {
