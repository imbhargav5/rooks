...
describe("usePreviousImmediate", function () {
  var useHook;
  beforeEach(function () {
    useHook = function () {
      var _a = (0, react_1.useState)(0),
        value = _a[0],
        setValue = _a[1];
      var previousValue = (0, usePreviousImmediate_1.usePreviousImmediate)(
        value
      );
  ...
  it("isDefined", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        expect(usePreviousImmediate_1.usePreviousImmediate).toBeDefined();
        return [2 /*return*/];
      });
    });
  });
