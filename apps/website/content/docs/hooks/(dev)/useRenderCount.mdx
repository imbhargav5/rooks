...
description: "Tracks and returns how many times a component has re-rendered."
---
...
<LiveExample code={`import { useRenderCount } from "rooks";
...
<LiveExample code={`import { useState, useEffect } from "react";
import { useRenderCount } from "rooks";
