...
description: "Calls setState only if the component is still mounted, preventing memory leaks."
entrypoint: rooks
status: stable
aliases: []
related: [useGetIsMounted]
---
...
- [useGetIsMounted](/docs/hooks/useGetIsMounted) exposes the mounted-state reader directly.
