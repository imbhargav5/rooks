---
title: useArrayState
description: "Manages an array state with helper methods for push, pop, splice, sort, and more."
entrypoint: rooks
status: stable
aliases: []
related: [useQueueState, useStackState]
---
  ...
  return (
    <div>
      ...
      >
        ...
        <button onClick={() => controls.unshift(0)}>Unshift 0</button>
        ...
        <button onClick={() => controls.fill(7)}>Fill with 7</button>
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ margin: "20px 0" }}>
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          <input
            ...
            style={{ width: "60px" }}
          />
          <button onClick={performSplice}>Splice (replace with 999)</button>
        </div>
      </div>
      ...
      <div style={{ margin: "20px 0" }}>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          <button onClick={() => controls.fill(0)}>Fill All with 0</button>
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <button onClick={sortOriginalArray}>Sort Original Array</button>
        <button onClick={addRandomItem}>Add Item</button>
        <button onClick={controls.clear}>Clear All</button>
      </div>
...
| -------------- | -------------------- | ---------------------------------- | ------- |
| initial        | `T[] \| (() => T[])` | Required array or lazy initializer | —       |
...
The hook has no browser dependency and is SSR-safe. Rendering an array still requires stable item keys and accessible list or table semantics appropriate to the UI.

## Related

- [useQueueState](/docs/hooks/useQueueState) provides first-in, first-out collection operations.
- [useStackState](/docs/hooks/useStackState) provides last-in, first-out collection operations.
