---
title: useSelect
description: "Manages a selection state from a list of options with helpers."
entrypoint: rooks
status: stable
aliases: []
related: [useSelectableList, useMultiSelectableList]
---
...
- [useSelectableList](/docs/hooks/useSelectableList)
