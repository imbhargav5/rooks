...
description: "Fires a callback when the user starts typing anywhere on the page."
---
...
<LiveExample code={`import { useOnStartTyping } from "rooks";
...
<LiveExample code={`// Example with options
