...
description: "Attaches a keyboard event handler to a ref element."
---
...
<LiveExample code={`import { useKeyRef } from "rooks";
...
<LiveExample code={`import { useKeyRef, useMergeRefs } from "rooks";
export default function App() {
  function vowelsEntered(e) {
    console.log("[Demo 1] You typed a vowel");
  }
