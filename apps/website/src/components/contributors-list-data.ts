export const contributorsListData = {
  ...
  files: ["apps/website/src/components/CONTRIBUTORS.md", "README.md"],
  imageSize: 100,
  commit: false,
  ...
  contributors: [
    ...
    {
      login: "uno-prod-internal-app[bot]",
      name: "uno-prod-internal-app[bot]",
      avatar_url: "https://avatars.githubusercontent.com/u/2936644?v=4",
      profile: "https://github.com/apps/uno-prod-internal-app",
      contributions: ["code"],
    },
    {
      login: "uno",
    ...
    },
    {
      ...
      profile: "https://openai.com/codex",
      contributions: ["code"],
    },
  ],
