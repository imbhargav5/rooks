...
const features = [
  {
    content: (
      <p>
        Rooks is extremely well documented with <strong>use-cases and examples</strong> described thoroughly.
      </p>
    ),
    image: (
      <svg className="w-24 h-24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
    ),
    imageAlign: 'top',
  ...
  },
  {
    ...
    image: (
      <svg className="w-24 h-24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path></svg>
    ),
    imageAlign: 'top',
  ...
  },
  {
    content: (
      <p>
        ESM, CommonJS or UMD. All platforms and codebases are supported.
      </p>
    ),
    image: (
      <svg className="w-24 h-24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
    ),
    imageAlign: 'top',
    title: 'Supports ESM'
  },
  {
    content: (
      <p>
        Hooks in the Rooks library are very <strong>versatile</strong> and easy to customise at the same time.
      </p>
    ),
    image: (
              ...
              <div className="row">
                {features.map(({ image, title, content }, idx) => (
                  <div key={idx} className={classnames('col', styles.feature)}>
                    {image && (
                      <div className={`text--center grid place-items-center ${styles.blockImage}`}>
                        {image}
                      </div>
                    )}
